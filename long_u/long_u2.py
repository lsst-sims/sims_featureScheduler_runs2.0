...
def generate_blobs(nside, nexp=2, exptime=30., filter1s=['u', 'u', 'g', 'r', 'i', 'z', 'y'],
    ...
    for filtername, filtername2 in zip(filter1s, filter2s):
        ...
        if u_nexp1:
            detailer_list.append(detailers.Filter_nexp(filtername='u', nexp=1, exptime=u_expt))
...
if __name__ == "__main__":
    ...
    u_expt = 50.  # u-band exposure time
    ...
    # lower the u-band
    footprints_hp['u'] = footprints_hp['u']*30./u_expt
    ...
    ddfs = generate_dd_surveys(nside=nside, nexp=nexp, detailers=details, u_exptime=u_expt,
