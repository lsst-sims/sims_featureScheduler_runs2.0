...
def gen_smc_survey(nside=32, nights=[368, 369], n_sequence=20):
    ...
    survey = Deep_drilling_survey(basis_functions, RA=RA, dec=dec, sequence='g'*n_sequence, exptime=15, nexp=1,
