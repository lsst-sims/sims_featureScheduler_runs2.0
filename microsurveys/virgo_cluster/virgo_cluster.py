...
class Virgo_map(Sky_area_generator):
    """modify the wfd to include Virgo
    """
    ...
    def set_dustfree_wfd(self, nvis_dustfree_wfd, dust_limit=0.199,
                         ...
                         adjust_halves=12, virgo_RA=186.75, virgo_dec=12.717, virgo_radius=8.75):
        ...
        virgo_pix = self._set_circular_region(virgo_RA, virgo_dec, virgo_radius)
        self.maps['dustfree'][np.where(virgo_pix > 0)] = 1
