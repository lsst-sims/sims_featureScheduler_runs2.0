...
if __name__ == "__main__":
    ...
    # Ugh, this should be folded into sky area generator. 
    north_limit = 30.
    stripe_val = 0.08  # So, 0.08 should be 6.5 visits per year.
    for filtername in 'ugrizy':
        in_stripe = np.where((sm.dec <= north_limit) & (footprints_hp[filtername] == 0))[0]
        footprints_hp[filtername][in_stripe] = stripe_val
