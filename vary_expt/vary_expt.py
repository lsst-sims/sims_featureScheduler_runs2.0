...
def gen_greedy_surveys(nside=32, nexp=2, exptime=30., filters=['r', 'i', 'z', 'y'],
                       ...
                       stayfilter_weight=3., footprints=None, target_m5=None):
    """
    ...
    surveys = []
    detailer_list = [detailers.Camera_rot_detailer(min_rot=np.min(camera_rot_limits),
                                                   max_rot=np.max(camera_rot_limits))]
    detailer_list.append(detailers.Vary_expt_detailer(target_m5=target_m5))
...
def generate_twi_blobs(nside, nexp=2, exptime=30., filter1s=['r', 'i', 'z', 'y'],
                       ...
                       wfd_footprint=None, target_m5=None):
    """
    Generate surveys that take observations in blobs.
