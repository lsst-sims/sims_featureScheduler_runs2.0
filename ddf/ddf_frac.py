...
if __name__ == "__main__":
    ...
    parser.add_argument("--ddf_frac", type=float, default=0.0185/2., help='fraction of visits for one DDF')
    ...
    if dbroot is None:
        ...
        fileroot = dbroot + '_'
    file_end = 'ddf_per%.1f_' % (ddf_frac*100) + 'v2.0_'
    ...
    ddfs = generate_dd_surveys(nside=nside, nexp=nexp, frac_total=ddf_frac,
                               detailers=details,
