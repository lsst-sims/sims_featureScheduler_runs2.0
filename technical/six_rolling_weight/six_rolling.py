...
if __name__ == "__main__":
    ...
    parser.add_argument("--rolling_nslice", type=int, default=6)
    ...
    parser.add_argument("--fpweight", type=float, default=1.5)
    ...
    if dbroot is None:
        ...
        fileroot = dbroot + '_'
    fileroot += 'ns%i_rw%.1f_fpw%.1f_' % (nslice, scale, fpweight)
    file_end = 'v2.0_'
    ...
    greedy = gen_greedy_surveys(nside, nexp=nexp, footprints=footprints, footprint_weight=fpweight)
