...
if __name__ == "__main__":
    ...
    parser.add_argument("--nes_frac", default=0.3, type=float)
    ...
    if dbroot is None:
        ...
        fileroot = dbroot + '_'
    file_end = 'nesfrac%.2f_' % nes_frac 
    file_end += 'v2.0_'

    if filters is None:
        sm = Sky_area_generator(nside=nside, nvis_frac_nes=nes_frac)
    else:
        ...
        sm = Sky_area_generator(nside=nside,
                                default_filter_balance=filter_balance, nvis_frac_nes=nes_frac)
