...
#SBATCH --chdir=/gscratch/scrubbed/yoachim/sims_featureScheduler_runs2.0/technical/no_nes
...
cd /gscratch/scrubbed/yoachim/sims_featureScheduler_runs2.0/technical/no_nes
