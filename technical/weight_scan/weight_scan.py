...
if __name__ == "__main__":
    ...
    parser.add_argument("--fp_weight", type=float, default=0.3)
    ...
    nexp = args.nexp
    footprint_weight = args.fp_weight
    ...
    fileroot += 'fpw%.1f_' % footprint_weight

    footprints_hp = combo_dust_fp(nside=nside)
    ...
    blobs = generate_blobs(nside, nexp=nexp, footprints=footprints, footprint_weight=footprint_weight)
    twi_blobs = generate_twi_blobs(nside, nexp=nexp, footprints=footprints, wfd_footprint=wfd_footprint,
                                   repeat_night_weight=repeat_night_weight, footprint_weight=footprint_weight)
